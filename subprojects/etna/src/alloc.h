...
#define ETNA_ALLOC_TYPE(parent, type) etna_allocator_allocate(etna_global_alloc, parent, sizeof(type))
...
void etna_allocator_init(etna_allocator_t* alloc, const size_t* bucket_sizes, const size_t bucket_count);
